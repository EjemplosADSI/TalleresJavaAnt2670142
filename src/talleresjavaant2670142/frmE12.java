 ...
 * @author grani
 */
public class frmE12 extends javax.swing.JFrame {

    /**
     * Creates new form frmE12
     */
    public frmE12() {
        initComponents();
    }
    ...
    /*  Ejercicio 12
        Se debe de ingresar un numero por el usuario, este debe de ser evaluado 
        para verificar que el número de cifras sea par y verificar si el número 
        es capicúa o no. Solamente se deben permitir números positivos.
    */
    ...
    public boolean numeroCapicua(){
        ...
        if(strNum.length() % 2 != 0){ 
            showError("El numero no tiene un numero de cifras par", "Error");
            txtNumero1.setText("");
            return false; 
        }
        int numero = Integer.parseInt(strNum);
        if (numero < 0) { showError("Numero negativo no valido", "Error"); return false;}
        StringBuilder reverseStrNum = new StringBuilder();
        reverseStrNum.append(strNum);
        reverseStrNum.reverse();
        int reverseNum = Integer.parseInt(reverseStrNum.toString());
        String result = (numero == reverseNum)? "SI" : "NO";
        lblResultado.setText("<html><center>El numero "+numero+" "+result+" es un numero capicua</center>");
        return true;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmE12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
