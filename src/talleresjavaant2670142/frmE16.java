...
public class frmE16 extends javax.swing.JFrame {
    ...
    /* Ejercicio 16
        Desarrollar un algoritmo que solicite una frase de mínimo 5 palabras 
        y capitalizar la cadena.
    */
    ...
    private void initComponents() {
        ...
        txtAreaCadena = new javax.swing.JTextArea();
        ...
        lblResultado.setBounds(20, 210, 200, 50);

        jLabel5.setFont(new java.awt.Font("Cascadia Code", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Cadena:");
        jpnFrmE01.add(jLabel5);
        jLabel5.setBounds(20, 110, 130, 20);

        txtAreaCadena.setColumns(20);
        txtAreaCadena.setRows(5);
        txtAreaCadena.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtAreaCadenaKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(txtAreaCadena);

        jpnFrmE01.add(jScrollPane1);
        jScrollPane1.setBounds(20, 130, 200, 50);
    ...
    public boolean numeroCapicua(){
        ...
        String strCadena = txtAreaCadena.getText();        
        String[] palabras = strCadena.split(" ");
        if (palabras.length < 5) { showError("Deben ser minimo 5 palabras", "Error"); return false;}
        ...
        for (String palabra : palabras) {
            if (palabra.length() > 0) {
                ...
                resultado.append(primerCaracter).append(restoPalabra).append(" ");
            }
        }

        String fraseCapitalizada = resultado.toString().trim();
        System.out.println();
  
        lblResultado.setText("<html><center>La frase capitalizada es: " + fraseCapitalizada+"</center>");
        return true;
    }
    ...
    private void txtAreaCadenaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAreaCadenaKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            numeroCapicua();
        }
    }//GEN-LAST:event_txtAreaCadenaKeyPressed
    ...
    private javax.swing.JTextArea txtAreaCadena;
